      ...
      <div className="max-w-[1280px] mx-auto px-6 relative z-10 space-y-8">
        ...
        <div className="relative max-w-[1180px] mx-auto pt-6 pb-20 min-h-[640px] flex items-center justify-center">
          ...
          */}
          ...
          {/* 7. Right Bottom Underlapping Prompt Pill (z-10, Left half passes under bottom-right corner of Portrait Image at top-[440px] right-[180px]!) */}
          <div className="hero-floating-card absolute right-[180px] top-[440px] hidden lg:flex items-center gap-2 bg-slate-900/90 backdrop-blur-md border border-white/25 rounded-full px-5 py-2.5 text-xs font-semibold text-white shadow-2xl z-10">
